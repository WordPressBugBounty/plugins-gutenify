...
function gutenify_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . gutenify_get_color_value( $core_button_styles['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color: ' . gutenify_get_color_value( $core_button_styles['color']['text'] ) . ';';
	}
	...
	if ( ! empty( $core_button_styles[':hover']['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color--background: ' . gutenify_get_color_value( $core_button_styles[':hover']['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles[':hover']['color']['text'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color: ' . gutenify_get_color_value( $core_button_styles[':hover']['color']['text'] ) . ';';
	}
