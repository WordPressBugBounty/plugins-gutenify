...
class Custom_list{
	public static function init() {
		...
		// add_filter( 'render_block', array( __CLASS__, 'list_render' ), 20, 3 );
	...
	public static function register_assets() {
		...
		wp_register_script( $handle, $base_url . 'dist/non-blocks/extend/custom-list/index.js', $assets['version'], true );
